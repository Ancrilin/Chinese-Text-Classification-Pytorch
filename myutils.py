        ...
        with open(file_path, 'r', encoding='utf-8') as fp:
            ...
            for line in tqdm(fp):
                ...
                if lin not in label_vocab:
                    ...
                    continue
        return label_vocab
    label_vocab = build_label_vocab(config.train_path)
    train = load_dataset(config.train_path, label_vocab, config.pad_size)
    dev = load_dataset(config.dev_path, label_vocab, config.pad_size)
    test = load_dataset(config.test_path, label_vocab, config.pad_size)
